...
def gen_pic_test_data():
    result = {  1:
                ...
                18: 
                {'indexs':(0, 1, 3, 4, 9, 20, 26, 28, 29, 30, 32, 38, 42, 48, 50, 51, 52, 54, 60, 71, 76, 77, 79, 80),
                 'digits':(7, 3, 9, 4, 8, 5, 1, 6, 2, 3, 1, 7, 5, 5, 7, 2, 9, 4, 3, 8, 2, 6, 5, 7)},
                19: 
                {'indexs':(4, 5, 8, 9, 14, 15, 16, 18, 26, 27, 29, 32, 37, 39, 40, 41, 43, 48, 51, 53, 54, 62, 64, 65, 66, 71, 72, 75, 76),
                 'digits':(4, 7, 2, 9, 6, 8, 5, 3, 6, 2, 8, 3, 6, 4, 1, 2, 8, 5, 3, 7, 8, 4, 1, 2, 6, 9, 5, 9, 3)},
                90: 
                {'indexs':(0, 8, 10, 12, 16, 20, 24, 28, 30, 32, 40, 48, 50, 52, 56, 60, 64, 68, 70, 72, 80),
                 'digits':(9, 5, 4, 7, 3, 8, 1, 3, 6, 7, 8, 3, 9, 6, 1, 9, 2, 6, 4, 5, 8)}
            }
